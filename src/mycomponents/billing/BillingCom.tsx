    ...
    return(
        <div className="w-full h-full grid grid-cols-3 gap-5">
            <div className=" w-full h-full col-span-2 grid grid-cols-4 gap-5">
                <div className=" w-full h-full col-span-2"><CreditCard/></div>
                <div className="w-full h-full">
                    <Card className="shadow-md w-full h-fit">
                        <CardHeader className=""><FontAwesomeIcon icon={faBuildingColumns} className="p-4 bg-blue-500 rounded-md text-white text-xl font-bold shadow-xl" /> </CardHeader>
                        <CardContent className="flex flex-col px-3 gap-2">
                            <span className="font-bold ">Salary</span>
                            <span className="text-xs text-gray-500">Belong Interactive</span>
                            <div className="flex justify-center items-center pt-2"><hr className="w-[60%] text-gray-50" /></div>
                ...
                <div className="w-full h-full">
                    <Card className="shadow-md w-full h-full">
                        <CardHeader className=""><FontAwesomeIcon icon={faP} className="p-4 bg-blue-500 rounded-md text-white text-xl font-bold shadow-xl" /> </CardHeader>
                        <CardContent className="flex flex-col gap-2 text-gray-500 text-xs">
                            ...
                            <span>Payment</span>
                            <div className="flex justify-center items-center h-fit pt-2"><hr className="w-[70%] text-gray-50" /></div>
                ...
                <div className="w-full h-full col-span-4"><PaymentMethodCom/></div>
            </div>
            <div className="w-full h-full "><InvoicesPage/></div>
        </div>
    )
}
