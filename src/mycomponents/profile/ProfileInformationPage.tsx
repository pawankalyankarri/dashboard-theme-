    ...
    return(
        <div className="w-full text-gray-500 grid gap-5">
            ...
            <div className="w-full h-full grid gap-2">
                ...
                <div className="flex gap-2" ><span className="text-gray-800 text-sm font-bold">Social:</span><span className="flex gap-3"><FaFacebook className="text-blue-500"/><FaTwitter className="text-sky-500"/><FaInstagram className="text-pink-900"/></span></div>
            </div>
        </div>
    )
}
