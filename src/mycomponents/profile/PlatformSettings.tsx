    ...
    return(
        <div className="w-full h-full grid gap-5">
            ...
            <div className="w-full flex gap-2 flex-col text-gray-500">
               ...
               <div className="flex gap-5  items-center">
                <Switch id="s1"/>
                <Label htmlFor="s1 " className="text-sm">New launches and projects</Label>
               </div>
               <div className="flex gap-5  items-center">
                <Switch id="s2"/>
                <Label htmlFor="s2" className="text-sm">Monthly product updates</Label>
               </div>
               <div className="flex gap-5  items-center">
                <Switch id="s3"/>
                <Label htmlFor="s3" className="text-sm">Subscribe to newsletter</Label>
               </div>
