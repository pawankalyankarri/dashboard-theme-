      ...
      <div className="w-full h-full flex justify-center">
        <Card className="absolute top-50 w-[95%] shadow-md">
          <CardHeader className=" w-full grid grid-cols-2">
            <div className="w-full flex gap-5">
              <img
                ...
                alt=""
                className="w-[70px] rounded-full shadow-sm"
              />
            ...
            <div className=" w-full flex justify-end ">
              <Tabs defaultValue="account" className="">
                <TabsList>
                  <TabsTrigger value="app"><FontAwesomeIcon icon={faHouse} /> App</TabsTrigger>
                  <TabsTrigger value="message"><FontAwesomeIcon icon={faEnvelope} /> Message</TabsTrigger>
                  <TabsTrigger value="settings"> <FontAwesomeIcon icon={faGear} /> Settings</TabsTrigger>
                </TabsList>
          ...
          <CardContent className=" w-full grid grid-cols-3 gap-5">
            <div className="w-full"><PlatformSettings/></div>
            <div className="w-full"><ProfileInformationPage/></div>
            <div className="w-full"><ConversationsPage/></div>
            <div className="w-full col-span-3"><ProjectsPage/></div>
          </CardContent>
        </Card>
      </div>
    </div>
